...
<%
    ...
    if (null==resultados)
        resultados = new <VOProducto>ArrayList();
    if (null==sMensaje)
        sMensaje ="";    
	...
	<!-- Contact page end-->
		...
		<div class="container">
			...
			<div class="blog-slider owl-carousel"> 
                            ...
                            %>
				<div class="blog-item">
					<div class="blog-thumb set-bg" data-setbg="img/Productos/<%=voProductoItem.getId()%>.jpg">
						<div class="blog-date">
							<h2><%=voProductoItem.getDuracion()%> </h2>
                                                        <p>Min</p>
						</div>
					</div>
					<div class="blog-head">
						<div class="blog-tags">$<%=voProductoItem.getPrecio()%></div>
                                                <h2><a href="#" onclick="consultarUsuario(<%=voProductoItem.getId()%>);" ><%=voProductoItem.getNombre()%></a></h2>
					</div>
				</div>
                                <%                                                                    
                                    }                                                                                                                                         
