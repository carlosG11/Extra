		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<form class="comment-form" name="consultarPerfil" method="post" action="SVTGerentePerfilModificar" onsubmit="return verificarEnvio();">
						<div class="row">
							<div class="col-md-6">
	...
	<script src="js/main.js"></script>
        ...
        <script language="javascript">
            ...
            function verificarEnvio(){
                var elements = document.consultarPerfil.elements;
