 ...
 * @author QTK
 */
@WebServlet(name = "SVTClienteCarritoDesplegar", urlPatterns = {"/SVTClienteCarritoDesplegar"})
public class SVTClienteCarritoDesplegar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("clienteCarritoConsultar.jsp").forward(request, response);
        }       
    }
