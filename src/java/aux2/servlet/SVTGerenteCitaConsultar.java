 ...
 * @author QTK
 */
@WebServlet(name = "SVTGerenteCitaConsultar", urlPatterns = {"/SVTGerenteCitaConsultar"})
public class SVTGerenteCitaConsultar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String sResultado;
            System.out.println("SVTGerenteCitaConsultar.1");
