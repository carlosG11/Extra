 ...
 * @author QTK
 */
@WebServlet(name = "SVTAdminPerfilModificar", urlPatterns = {"/SVTAdminPerfilModificar"})
public class SVTAdminPerfilModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("".equals(sResultado) ){
                ...
                request.getRequestDispatcher("adminPerfilConsultar.jsp").forward(request, response);
            } else {
