 ...
 * @author QTK
 */
@WebServlet(name = "SVTGerenteGenerarReporteSemanal", urlPatterns = {"/SVTGerenteGenerarReporteSemanal"})
public class SVTGerenteGenerarReporteSemanal extends HttpServlet {
...
//            sResultado = FACCita.generarReporteSemanal(voCita,resultados);
            sResultado = FACCita.generarReporteServicios(voCita,resultados);
            ...
            request.getRequestDispatcher("gerenteReporteSemanal.jsp").forward(request, response);
        }       
    }
