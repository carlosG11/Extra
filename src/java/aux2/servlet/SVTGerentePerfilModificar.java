 ...
 * @author QTK
 */
@WebServlet(name = "SVTGerentePerfilModificar", urlPatterns = {"/SVTGerentePerfilModificar"})
public class SVTGerentePerfilModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sResultado;
            System.out.println("SVTGerentePerfilModificar: id["+request.getParameter("id")+"]");
            ...
            if ("".equals(sResultado) ){
                ...
                request.getRequestDispatcher("gerentePerfilConsultar.jsp").forward(request, response);
            } else {
