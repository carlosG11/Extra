...
<%
    ...
    VOUsuario resultado;
    resultado = (VOUsuario)request.getAttribute("resultado");
    if (null==sMensaje)
        sMensaje ="";    
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<form class="comment-form" name="consultarUsuario" method="post" action="SVTAdminUsuarioModificar" onsubmit="return verificarEnvio();">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                              ...
                                                              <select class="custom-select" id="perfil" name="perfil" disabled>
                                                                ...
                                                                <option value="estilista" <%="estilista".equals(resultado.getPerfil())?"selected":""%>>Estilista</option>
	...
	<script src="js/main.js"></script>
        ...
        <script language="javascript">
            ...
            function validarModificar(switchModificar){
                ...
                document.consultarUsuario.nombre.disabled=b;
                document.consultarUsuario.paterno.disabled=b;
                document.consultarUsuario.materno.disabled=b;
                document.consultarUsuario.perfil.disabled=b;
                document.consultarUsuario.calle.disabled=b;
                document.consultarUsuario.exterior.disabled=b;
                document.consultarUsuario.interior.disabled=b;
                document.consultarUsuario.colonia.disabled=b;
                document.consultarUsuario.municipio.disabled=b;
                document.consultarUsuario.telefono.disabled=b;
                document.consultarUsuario.correo.disabled=b;
                document.consultarUsuario.sucursal.disabled=b;
                document.consultarUsuario.botonguardar.disabled=b;
                document.consultarUsuario.botonprueba.disabled=b;
            }            
