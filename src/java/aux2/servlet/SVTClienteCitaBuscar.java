 ...
 * @author QTK
 */
@WebServlet(name = "SVTClienteCitaBuscar", urlPatterns = {"/SVTClienteCitaBuscar"})
public class SVTClienteCitaBuscar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultados = DAOCita.buscarPorCliente(voCita);
