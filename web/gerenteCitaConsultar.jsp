...
<body>
	...
	<!-- Forma -->
	<!-- Back to top -->
        <form class="comment-form" name="cancelarCita" method="post" action="SVTGerenteCitaCancelar" onsubmit="return verificarCancelacion();">
	<div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-9" >
                    <div class="input-group mb-9">
                        <input type="hidden" name="cliente" id="cliente" value="<%=voCita.getCliente()%>">
                        <input type="hidden" name="clienteNombre" id="clienteNombre" value="<%=voCita.getClienteNombre()%>">
                        <input type="hidden" name="clientePaterno" id="clientePaterno" value="<%=voCita.getClientePaterno()%>">
                        <input type="hidden" name="clienteMaterno" id="clienteMaterno" value="<%=voCita.getClienteMaterno()%>">
                        <label for="clienteTexto">Cliente<br><p></label>
                        <select class="browser-default custom-select " id="clienteTexto" name="clienteTexto" required disabled>
                            <option value="<%=voCita.getCliente()%>" selected><%=voCita.getClienteNombre()%> <%=voCita.getClientePaterno()%> <%=voCita.getClienteMaterno()%> </option>
                        </select>                                                                    
                    </div>
                </div>
            </div>                    
            ...
            <div class="row">
                <div class="col-md-3">
                    <button class="btn btn-info btn-block my-6"  id="botoncontinuar" name="botoncontinuar" type="submit" onclick="validarPago();">Registrar un Pago</button>
                </div>
                <div class="col-md-9">
                    &nbsp;
                </div>
	...
	<!-- Footer section end -->        
        ...
        <script language="javascript">
            ...
            var bRegistrarPago=false;
                        
            function verificarCancelacion(){
                if (bRegistrarPago){
                    if (confirm("Desea Registrar un Pago?")){
                        document.cancelarCita.action="SVTGerenteCitaRegistrarPago";
                        return true;                        
                    }                    
                }
                return confirm("Desea Cancelar la Cita?");
            }
