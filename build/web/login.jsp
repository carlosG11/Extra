		...
		<nav class="navbar navbar-expand-md navbar-dark bg-dark site-navbar">
			...
			<div class="collapse navbar-collapse" id="collapsibleNavId">
				...
				<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link" href="registrarUsuario.jsp">Nuevo Usuario</a>
					</li>
				</ul>
			</div>
		</nav>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<form class="comment-form" method="post" action="SVTLogin" >
						<div class="row">
							<div class="col-md-6">
								<input name="usuario" pattern="[a-zA-Z][a-zA-Z\d]+" id="usuario" placeholder="usuario" required maxlength=18>
							</div>
							<div class="col-md-6">
