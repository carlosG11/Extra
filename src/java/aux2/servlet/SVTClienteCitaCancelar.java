 ...
 * @author QTK
 */
@WebServlet(name = "SVTClienteCitaCancelar", urlPatterns = {"/SVTClienteCitaCancelar"})
public class SVTClienteCitaCancelar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sResultado = FACCita.cancelar(voCita);
            if ("".equals(sResultado)){
                //el usuario es un cliente
                request.setAttribute("mensaje","&Eacute;xito al cancelar la Cita(s).");
