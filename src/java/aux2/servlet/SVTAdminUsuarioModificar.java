 ...
 * @author QTK
 */
@WebServlet(name = "SVTAdminUsuarioModificar", urlPatterns = {"/SVTAdminUsuarioModificar"})
public class SVTAdminUsuarioModificar extends HttpServlet {
...
//            voUsuario.setPassword(request.getParameter("password"));
            ...
            if ("".equals(sResultado) ){
                request.setAttribute("mensaje","El Usuario se ha modificado exitosamente.");
                request.getRequestDispatcher("adminUsuarioConsultar.jsp").forward(request, response);
            } else {
                request.setAttribute("mensaje","Error al modificar Usuario.");
                request.getRequestDispatcher("adminUsuarioConsultar.jsp").forward(request, response);
            }
