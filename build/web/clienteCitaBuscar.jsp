                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <div class="search-form">
                                    <form name="formulario" method="post" action="SVTClienteCitaBuscar" >
                                    ...
                                    <form name="formularioConsultar" id="formularioConsultar" method="post" action="SVTClienteCitaConsultar" >
